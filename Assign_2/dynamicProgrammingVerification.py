...
while any(amountInFleet > 0 for amountInFleet in Fleet.amount.values()):
    ...
    for i in range(len(routeFlights) - 1):
        ...
        if currentNode.cargo != 0:
            ...
            demandCaptureAvailable = DEMAND_CAPTURE_PREVIOUS * (
                        prevBinFlightDemandCurrent + prevPrevBinFlightDemandCurrent) + binFlightDemandCurrent
